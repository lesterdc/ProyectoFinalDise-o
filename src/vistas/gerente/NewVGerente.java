...
public class NewVGerente extends javax.swing.JFrame {
    ...
    static Usuario usuarioAdmin=null;
    ...
    private void bAsignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAsignarActionPerformed
        ...
        usuarioAdmin= new Usuario(nombre,"","","",0);
        usuarioAdmin.setUsuario(usuario);
        usuarioAdmin.setIsAdmin(1);
        ControladorGerente.asignarAdmi(usuarioAdmin);
    ...
    private void cBusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cBusquedaKeyReleased
        System.err.print(evt.toString());        
        String local=cBusqueda.getText();
            ControladorGerente.buscarUsuario(local);
    ...
    public  JTable gettUsuarios() {
        return tUsuarios;
    }

    public  void settUsuarios(JTable tUsuarios) {
